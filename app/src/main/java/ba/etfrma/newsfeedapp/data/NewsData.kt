...
fun getAllNews(): List<NewsItem> {
    return listOf(
        ...
        NewsItem("2", "Spektakularan preokret u posljednjoj minuti donosi pobjedu domaćinu",
            ...
            imageUrl = null, "Sport", true, "Sport Klub", "2025-02-07"),
        ...
        NewsItem("17", "Cristiano Ronaldo postigao 800. gol u profesionalnoj karijeri",
        ...
        NewsItem("18", "EU usvojila nove sankcije prema Rusiji zbog vojne eskalacije u Ukrajini", "Europska unija" +
        ...
        NewsItem( "19", "Sudan: Politička kriza u zemlji se pogoršava, deseci poginulih u sukobima",
        ...
        NewsItem( "20", "Lionel Messi pomogao Interu Miami u osvojenju prve MLS titule",
        ...
        NewsItem( "21", "NASA lansira novu misiju za istraživanje Marsa", "NASA je uspješno lansirala novu misiju koja ima za cilj istraživanje mogućnosti ljudske kolonizacije Marsa, a prvi podaci očekuju se za nekoliko mjeseci.",
